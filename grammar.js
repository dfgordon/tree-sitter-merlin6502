...
module.exports = grammar({
	...
	rules: {
		...
		operation: $ => choice(
			seq(optional($.label_def), $._sep, $.op_adc, $._sep, field('c3',choice($.addr,$.addr_s,$.addr_x,$.addr_y,$.daddr,$.daddr_y,$.iaddr,$.iaddr_is_y,$.iaddr_ix,$.iaddr_y,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_and, $._sep, field('c3',choice($.addr,$.addr_s,$.addr_x,$.addr_y,$.daddr,$.daddr_y,$.iaddr,$.iaddr_is_y,$.iaddr_ix,$.iaddr_y,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_asl, optional(seq($._sep, field('c3',choice($.addr,$.addr_x)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_bcc, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_bcs, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_beq, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_bit, $._sep, field('c3',choice($.addr,$.addr_x,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_bmi, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_bne, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_bpl, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_bra, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_brk, $._sep, field('c3',$.imm), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_bvc, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_bvs, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_cmp, $._sep, field('c3',choice($.addr,$.addr_s,$.addr_x,$.addr_y,$.daddr,$.daddr_y,$.iaddr,$.iaddr_is_y,$.iaddr_ix,$.iaddr_y,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_cpx, $._sep, field('c3',choice($.addr,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_cpy, $._sep, field('c3',choice($.addr,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_dec, optional(seq($._sep, field('c3',choice($.addr,$.addr_x)))), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_eor, $._sep, field('c3',choice($.addr,$.addr_s,$.addr_x,$.addr_y,$.daddr,$.daddr_y,$.iaddr,$.iaddr_is_y,$.iaddr_ix,$.iaddr_y,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_inc, optional(seq($._sep, field('c3',choice($.addr,$.addr_x)))), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_jmp, $._sep, field('c3',choice($.addr,$.iaddr,$.iaddr_ix)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_jsr, $._sep, field('c3',choice($.addr,$.iaddr_ix)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_lda, $._sep, field('c3',choice($.addr,$.addr_s,$.addr_x,$.addr_y,$.daddr,$.daddr_y,$.iaddr,$.iaddr_is_y,$.iaddr_ix,$.iaddr_y,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_ldx, $._sep, field('c3',choice($.addr,$.addr_y,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_ldy, $._sep, field('c3',choice($.addr,$.addr_x,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_lsr, optional(seq($._sep, field('c3',choice($.addr,$.addr_x)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_nop, optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_ora, $._sep, field('c3',choice($.addr,$.addr_s,$.addr_x,$.addr_y,$.daddr,$.daddr_y,$.iaddr,$.iaddr_is_y,$.iaddr_ix,$.iaddr_y,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_rol, optional(seq($._sep, field('c3',choice($.addr,$.addr_x)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_ror, optional(seq($._sep, field('c3',choice($.addr,$.addr_x)))), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_sbc, $._sep, field('c3',choice($.addr,$.addr_s,$.addr_x,$.addr_y,$.daddr,$.daddr_y,$.iaddr,$.iaddr_is_y,$.iaddr_ix,$.iaddr_y,$.imm)), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_sta, $._sep, field('c3',choice($.addr,$.addr_s,$.addr_x,$.addr_y,$.daddr,$.daddr_y,$.iaddr,$.iaddr_is_y,$.iaddr_ix,$.iaddr_y)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_stx, $._sep, field('c3',choice($.addr,$.addr_y)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_sty, $._sep, field('c3',choice($.addr,$.addr_x)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_stz, $._sep, field('c3',choice($.addr,$.addr_x)), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_trb, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_tsb, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_brl, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_cop, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_jml, $._sep, field('c3',$.iaddr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_jsl, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_mvn, $._sep, field('c3',$.xyc), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_mvp, $._sep, field('c3',$.xyc), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_pea, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_pei, $._sep, field('c3',$.iaddr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_per, $._sep, field('c3',$.addr), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_rep, $._sep, field('c3',$.imm), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_rtl, optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_sep, $._sep, field('c3',$.imm), optional(seq($._sep,$.comment)), $._newline),
		...
		pseudo_operation: $ => choice(
			seq(optional($.label_def), $._sep, $.psop_equ, $._sep, field('c3',$._aexpr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_ext, optional(seq($._sep, field('c3',seq($.label_def,repeat(seq(',',$.label_def)))))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_exd, optional(seq($._sep, field('c3',seq($.label_def,repeat(seq(',',$.label_def)))))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_ent, optional(seq($._sep, field('c3',seq($.label_ref,repeat(seq(',',$.label_ref)))))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_org, optional(seq($._sep, field('c3',$._aexpr))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_rel, optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_cas, $._sep, field('c3',alias(choice(caseRe('se'),caseRe('in')),$.enum)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_obj, $._sep, field('c3',$._aexpr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_put, $._sep, field('c3',$.filename), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_use, $._sep, field('c3',$.filename), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_var, $._sep, field('c3',seq($._aexpr,repeat(seq(';',$._aexpr)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_sav, $._sep, field('c3',$.filename), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_typ, $._sep, field('c3',$._aexpr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_dsk, $._sep, field('c3',$.filename), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_end, optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_dum, $._sep, field('c3',$._aexpr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_dend, optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_ast, $._sep, field('c3',$._aexpr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_cyc, optional(seq($._sep, field('c3',alias(choice(caseRe('off'),caseRe('ave'),caseRe('flags')),$.enum)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_dat, optional(seq($._sep, field('c3',$._aexpr))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_exp, $._sep, field('c3',alias(choice(caseRe('on'),caseRe('off'),caseRe('only')),$.enum)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_lst, optional(seq($._sep, field('c3',choice(alias(choice(caseRe('on'),caseRe('off'),caseRe('rtn')),$.enum),seq(alias(caseRe('file'),$.enum),',',$.filename))))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_lstdo, optional(seq($._sep, field('c3',alias(caseRe('off'),$.enum)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_pag, optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_ttl, $._sep, field('c3',$.dstring), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_skp, $._sep, field('c3',$._aexpr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_tr, optional(seq($._sep, field('c3',alias(choice(caseRe('on'),caseRe('off'),caseRe('adr')),$.enum)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_asc, $._sep, field('c3',choice($._string_operand,$._num_str)), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_dci, $._sep, field('c3',$._string_operand), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_inv, $._sep, field('c3',$._string_operand), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_fls, $._sep, field('c3',$._string_operand), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_rev, $._sep, field('c3',$.dstring), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_str, $._sep, field('c3',$._string_operand), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_strl, $._sep, field('c3',$._string_operand), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_da, $._sep, field('c3',seq($._aexpr,repeat(seq(',',$._aexpr)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_ddb, $._sep, field('c3',seq($._aexpr,repeat(seq(',',$._aexpr)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_dfb, $._sep, field('c3',seq($._data_aexpr,repeat(seq(',',$._data_aexpr)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_flo, $._sep, field('c3',$.dstring), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_adr, $._sep, field('c3',seq($._aexpr,repeat(seq(',',$._aexpr)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_adrl, $._sep, field('c3',seq($._aexpr,repeat(seq(',',$._aexpr)))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_hex, $._sep, field('c3',$.hex_data), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_ds, $._sep, field('c3',choice($._aexpr,seq($._aexpr,',',$._aexpr),'\\',seq('\\',',',$._aexpr))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_do, $._sep, field('c3',$._aexpr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_else, optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_if, $._sep, field('c3',choice($.if_char,$.if_mx)), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.psop_err, $._sep, field('c3',choice($.ptr_check,seq(optional('\\'),$._aexpr))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_kbd, optional(seq($._sep, field('c3',$.dstring))), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_lup, $._sep, field('c3',$._aexpr), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_end_lup, optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_mx, $._sep, field('c3',$._aexpr), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.psop_usr, $._sep, field('c3',$.literal), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.psop_xc, optional(seq($._sep, field('c3',alias(caseRe('off'),$.enum)))), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.psop_pmc, $._sep, field('c3',seq(field('mac',$.label_ref),optional(seq($._arg_sep,$.macro_args)))), optional(seq($._sep,$.comment)), $._newline)
		),
