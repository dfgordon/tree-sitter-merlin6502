...
module.exports = grammar({
	...
	rules: {
		...
		op_bcc: $ => seq(token(prec(1,choice('blt','BLT','bcc','BCC'))),optional($.trailing)),
		op_bcs: $ => seq(token(prec(1,choice('bcs','BCS','BGE','bge'))),optional($.trailing)),
		...
		op_tcd: $ => seq(token(prec(1,choice('tad','TCD','tcd','TAD'))),optional($.trailing)),
		op_tcs: $ => seq(token(prec(1,choice('TCS','TAS','tcs','tas'))),optional($.trailing)),
		op_tdc: $ => seq(token(prec(1,choice('TDA','TDC','tda','tdc'))),optional($.trailing)),
		op_tsc: $ => seq(token(prec(1,choice('TSA','TSC','tsc','tsa'))),optional($.trailing)),
		...
		operation: $ => choice(
			seq(optional($.label_def), $._sep, $.op_adc, $._sep, choice($.daddr_y,$.addr,$.addr_s,$.imm,$.iaddr,$.iaddr_is_y,$.addr_x,$.iaddr_y,$.iaddr_ix,$.daddr,$.addr_y), optional(seq($._sep,$.comment)), $._newline),
			seq(optional($.label_def), $._sep, $.op_and, $._sep, choice($.daddr_y,$.addr,$.addr_s,$.imm,$.iaddr,$.iaddr_is_y,$.addr_x,$.iaddr_y,$.iaddr_ix,$.daddr,$.addr_y), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_cmp, $._sep, choice($.daddr_y,$.addr,$.addr_s,$.imm,$.iaddr,$.iaddr_is_y,$.addr_x,$.iaddr_y,$.iaddr_ix,$.daddr,$.addr_y), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_eor, $._sep, choice($.daddr_y,$.addr,$.addr_s,$.imm,$.iaddr,$.iaddr_is_y,$.addr_x,$.iaddr_y,$.iaddr_ix,$.daddr,$.addr_y), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_lda, $._sep, choice($.daddr_y,$.addr,$.addr_s,$.imm,$.iaddr,$.iaddr_is_y,$.addr_x,$.iaddr_y,$.iaddr_ix,$.daddr,$.addr_y), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_ora, $._sep, choice($.daddr_y,$.addr,$.addr_s,$.imm,$.iaddr,$.iaddr_is_y,$.addr_x,$.iaddr_y,$.iaddr_ix,$.daddr,$.addr_y), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_sbc, $._sep, choice($.daddr_y,$.addr,$.addr_s,$.imm,$.iaddr,$.iaddr_is_y,$.addr_x,$.iaddr_y,$.iaddr_ix,$.daddr,$.addr_y), optional(seq($._sep,$.comment)), $._newline),
			...
			seq(optional($.label_def), $._sep, $.op_sta, $._sep, choice($.daddr_y,$.addr,$.addr_s,$.iaddr,$.iaddr_is_y,$.addr_x,$.iaddr_y,$.iaddr_ix,$.daddr,$.addr_y), optional(seq($._sep,$.comment)), $._newline),
		...
		psop_dfb: $ => seq(token(prec(1,choice('DFB','dfb','db','DB'))),optional($.trailing)),
